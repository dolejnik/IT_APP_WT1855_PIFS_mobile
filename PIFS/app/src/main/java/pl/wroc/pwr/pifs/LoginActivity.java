...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        private final String url_login = "http://serviceofelectronicdevices.azurewebsites.net/Api/Login";
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            params3.add(new BasicNameValuePair("Email", mEmail));
            params3.add(new BasicNameValuePair("Password", mPassword));
            ...
            try {
                ...
                if(prev_token.equals(token)){
                    Log.d("ResponseErr", "PREVIOUS TOKEN WAS THE SAME");
                    return false;
                }
                prev_token=token;
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                ...
                Intent i = new Intent(getApplicationContext(), panel_user.class);
                startActivity(i);
                //finish();
            } else {
